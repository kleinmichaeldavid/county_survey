...
t1 <- kable(department_resps, format = "latex", booktabs = TRUE)
...
t1 <- kable(position_resps, format = "latex", booktabs = TRUE)
t2 <- kable(status_resps, format = "latex", booktabs = TRUE)

cat(c("\\begin{table}[!htb]
    \\begin{minipage}{.5\\linewidth}
      \\caption{Responses by Position Type}
      \\centering",
        t1,
    "\\end{minipage}%
    \\begin{minipage}{.5\\linewidth}
      \\centering
        \\caption{Responses by Employment Status}",
        t2,
    "\\end{minipage} 
\\end{table}"
))  
...
t1 <- kable(duration_resps, format = "latex", booktabs = TRUE)
t2 <- kable(birth_resps, format = "latex", booktabs = TRUE)

cat(c("\\begin{table}[!htb]
    \\begin{minipage}{.5\\linewidth}
      \\caption{Responses by Length of Service}
      \\centering",
        t1,
    "\\end{minipage}%
    \\begin{minipage}{.5\\linewidth}
      \\centering
        \\caption{Responses by Generation}",
        t2,
    "\\end{minipage} 
\\end{table}"
))  
